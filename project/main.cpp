...
void rainy()
{
    ...
    if (position_5> 220)
        position_5 = -180.0f;
    position_5 +=speed_car+.1;

    if (position_6< -220)
        position_6 = 220.0f;
    position_6 -=speed_car+.1;
    glutPostRedisplay();
}
...
glutCreateWindow("Metro Rail by Monir"); // Create a window with the given title
